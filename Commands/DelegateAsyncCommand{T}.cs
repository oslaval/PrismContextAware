...
namespace Prism.Commands
{
    ...
    public class DelegateAsyncCommand<T> : DelegateCommandBase
    {
        ...
        private bool CanExecuteAgain() => _allowMultipleExecution ? true : !IsExecuting;
        ...
        public bool CanExecute(T parameter) => _canExecute?.Invoke(parameter) ?? true && CanExecuteAgain();
        ...
        /// <param name="parameter">Parameter.</param>
        public async Task ExecuteAsync(T parameter) => await _commandTask.Invoke(parameter);
        ...
        protected override async void Execute(object parameter)
        {
            ...
            try
            {
                await ExecuteAsync((T)parameter); //.ContinueWith((p) => { _exceptionHandler?.Invoke(p?.Exception); });
            }                        
            catch (Exception ex)
            {                
